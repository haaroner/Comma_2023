...
extern "C"
{
  void SPI3_IRQHandler(void)
  {
    ...
    if (SPI_I2S_GetFlagStatus(SPI3, SPI_I2S_FLAG_RXNE))
    {
      ...
      Spi_3::_rx_buffer[Spi_3::_cur_rx_write] = it_data;
      
      if(Spi_3::_cur_rx_write == 7) Spi_3::_cur_rx_write = 0;
      else Spi_3::_cur_rx_write++;
      
      if(Spi_3::_buf_size < 7) Spi_3::_buf_size++;
    }
  } 
}
