...
mpu9250_spi::mpu9250_spi(pin &ssPin): _ss_pin(ssPin)
{
}
...
void mpu9250_spi::initIMU(pin &ssPin)
{
  _ss_pin = ssPin;
  ...
  initSPI2(1, 8, 256);  
  //Spi_2::spi_init(master_mode, simple, fullDuplex, d8b, b256r,msb); 			//init spi
  ...
  SPI2->CR1 &= ~SPI_CR1_BR;
	...
	//Spi_2::spi_deinit();
  //Spi_2::spi_init(master_mode, simple, fullDuplex, d8b, b4r, msb);
