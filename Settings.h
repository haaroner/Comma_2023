...
#define DEFENDER_BALL_THRESHOLD 8

#define ATTACKER_MAX_LINEAR_TRAJECTORY_SPEED 40
#define ATTACKER_MIN_LINEAR_TRAJECTORY_SPEED 15
#define ATTACKER_MAX_ANGULAR_TRAJECTORY_SPEED 7
