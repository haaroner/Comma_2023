...
//            }
          ...
          if((robot_x > 50 && attacker_state == 0 && robot_y > 100) || (robot_x > 50 && attacker_state == 0 && robot_y <= 100) || ((robot_x > 37 && attacker_state != 0))) 
          {
            move_angle = lead_to_degree_borders(-90 - gyro);
            if(attacker_state == 0) move_speed = 63;
          }
          else if((robot_x < -42 && attacker_state == 0 && robot_y > 100)|| (robot_x < -50 && attacker_state == 0 && robot_y <= 100) || (robot_x < -40 && attacker_state != 0))
          {
             move_angle = lead_to_degree_borders(90 - gyro);
             if(attacker_state == 0) move_speed = 63;
          }
