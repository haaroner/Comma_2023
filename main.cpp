...
int16_t move_angle = 0, move_speed = 0, gyro, forward_angle, backward_angle, ball_angle, 
    ...
    else if(gaming_state == 1)
    {
      ...
      if(role == 1) // atacker
      {
        ...
        {         
          ...
          {
            Robot::moveRobotAbs(ball_abs_angle, 22);
            Robot::set_dribler_speed(0);
          }
          else //move slowly
          {
...
//          }
        ...
        {
          Robot::set_dribler_speed(20);
          point_reached = Robot::moveToPoint(37 * my_sgn(attacker_start_state_point.x), 205, 8);
          Robot::setAngle(lead_to_degree_borders(forward_angle + 180), 3, -0.02);
          ...
          if(point_reached)
          {
            Robot::wait(500);
            Robot::setAngle(0, 0, -0.1);
            Robot::wait(2000, true, 90 * my_sgn(attacker_start_state_point.x), 2);
            Robot::wait(2000, true, -60 * my_sgn(attacker_start_state_point.x), 2);
            Robot::set_dribler_speed(20);
            Robot::wait(500);
