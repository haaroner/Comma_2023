...
point ball_track_position, backward_gate_center;
...
//        }
      ...
      if(role == 2)
      {
        ...
        if(defender_state == 1)
        {
          ...
          if(Robot::predict()) defender_state = 2;
        ...
        if(defender_state == 1)
        {
          ...
          move_speed = constrain(90, 6, pow(47 * my_abs(defender_angle_error), 0.5));
          ...
          {       
            ...
            Robot::display_data(defender_angle_error, pow(double(10 * 90), double(0.3)));
            move_angle = sum_of_vectors(move_angle, move_speed, defender_y_angle, my_abs(defender_y_error));
            move_speed = get_len_from_sum_of_vectors();
            Robot::setAngle(0, 14, -0.36);
        ...
        if(defender_state == 2)
        {
          Robot::moveToPoint(Robot::predicted_point, 40);
          Robot::setAngle(0, 12, -0.35);
